...
The direct-exchange terms are multiplied by $\cos \theta_{23}$, as seen in \cref{eq:PWavePhi2Phi2}.
\begin{center}
\begin{longtable}{|c|c|c|}
...
From \cref{eq:PWavePhi1Phi2}, the direct-direct terms are multiplied by $\cos \theta_{12}$, and the direct-exchange terms are multiplied by $\cos \theta_{13}$.
\begin{center}
\begin{longtable}{|c|c|c|}
...
From \cref{eq:PWavePhi1Phi2}, both the direct-direct terms and direct-exchange terms are multiplied by $\cos \theta_{12}$.
\begin{center}
\begin{longtable}{|c|c|c|}
\caption{Direct-Direct and Direct-Exchange Terms - $\phi_{2i} \phi_{2j}$ and $\phi_{2i} \phi_{2j}^\prime$}
