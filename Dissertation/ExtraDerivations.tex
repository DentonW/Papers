...
\begin{align}
\label{eq:LSGenLapl1}
\frac{\Laplacian_\rho \left[\SphericalHarmonicY{\ell}{0}{\theta_\rho}{\phi_\rho} j_\ell(\kappa\rho) \right]}{\SphericalHarmonicY{\ell}{0}{\theta_\rho}{\phi_\rho} j_\ell(\kappa\rho)} = \frac{(n + n^2 - \kappa^2 \rho^2) \LegendreP{\ell, \cos\theta} + 2 \cot\theta \, \AssocLegendreP{\ell}{1}{\cos\theta} + \AssocLegendreP{\ell}{2}{\cos\theta}} {\rho^2 \LegendreP{\ell, \cos\theta}}.
\end{align}
...
\eeq
Substituting this back into \cref{eq:LSGenLapl1}, we get cancellations with the associated Legendre polynomials and see that $\SphericalHarmonicY{\ell}{0}{\theta_\rho}{\phi_\rho} j_\ell(\kappa\rho)$ is an eigenfunction of $\Laplacian_\rho$ with eigenvalue $-\kappa^2$:
\begin{align}
\label{eq:LSGenLapl2}
