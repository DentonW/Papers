...
\caption{Ground state energy of $^1$S PsH with full set of terms}
...
state energies using the restricted set of terms with Todd ordering. The 
cutoffs in $\omega$ are easily seen using the ViewOmegaCutoffs.py script 
described on the Wiki \cite{Wiki}.
