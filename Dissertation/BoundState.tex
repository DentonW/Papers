...
\begin{figure}[H]
	\centering
	\includegraphics[width=5.5in]{singlet-eigen}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=5.5in]{triplet-eigen}
...
Plotting the first 10 eigenvalues with respect to $N$ for $^1$S gives \cref{fig:singlet-eigen}. As noted, the dashed line represents the Ps(n=2) inelastic threshold at $\SI{5.101}{eV}$. The dotted lines correspond to the first two complex Kohn $^1$S resonance positions given in \cref{tab:SWaveResonancesOther}. 
