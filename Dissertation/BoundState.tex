...
consists of one atom of positronium and one of hydrogen. We model it the 
...
Our wavefunction for the bound state is a Hylleraas-style \cite{Yan1999,VanReeth2003} set of terms, given by
\begin{subequations}
...
$r_i$ and $r_{ij}$ are constructed in such a way that
\beq
\label{eq:OmegaDef}
...
The most powerful property of the Rayleigh-Ritz variational method is the 
...
terms for the Ps-H scattering problem. \Cref{tab:BoundEnergyTodd1} gives the 
