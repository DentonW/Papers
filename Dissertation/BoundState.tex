...
\bottomrule
\end{tabular}
\caption{Ground state energy of PsH} % title of Table
...
\bottomrule
\end{tabular}
\caption{Ground state energy of PsH with full set of terms} % title of Table
...
\bottomrule
\end{tabular}
\caption{Ground state energy of PsH with restricted Todd set of terms} % title of Table
