...
\begin{equation}
\label{eq:DWavePhi1SBar}
\left(\bar{\phi}_{1i},\mathcal{L} \bar{S}_\ell\right) 
= \sqrt{2} \cdot 2\pi \bigintsss \phi_{1i} \left[ \left(1 - \frac{3 r_2^2 \sin^2\theta_{12}}{8 \rho^2} \right) \mathscr{L}S_\ell \pm \left(1 - \frac{3 r_3^2 \sin^2\theta_{13}}{8 {\rho^\prime}^2} \right) \mathscr{L}S_\ell^\prime \right] d\tau_{int}
\end{equation}

\begin{equation}
\label{eq:DWavePhi1CBar}
\left(\bar{\phi}_{1i},\mathcal{L} \bar{C}_\ell\right)
= \sqrt{2} \cdot 2\pi \bigintsss \phi_{1i} \left[ \left(1 - \frac{3 r_2^2 \sin^2\theta_{12}}{8 \rho^2} \right) \mathscr{L}C_\ell \pm \left(1 - \frac{3 r_3^2 \sin^2\theta_{13}}{8 {\rho^\prime}^2} \right) \mathscr{L}C_\ell^\prime \right] d\tau_{int}
\end{equation}

\begin{align}
\label{eq:DWavePhi2SBar}
\nonumber \left(\bar{\phi}_{2j},\mathcal{L} \bar{S}_\ell\right) =& \sqrt{2} \cdot 2\pi \bigintsss \phi_{2j} \left[ \left( \frac{3(r_1 \cos\theta_{12} + r_2)^2}{8 \rho^2} - \frac{1}{2} \right) \mathscr{L}S_\ell \right. \\
& \left. \pm \left( \frac{3(r_1 \cos\theta_{12} + r_3 \cos\theta_{23})^2}{8 {\rho^\prime}^2} - \frac{1}{2} \right) \mathscr{L}S_\ell^\prime \right] d\tau_{int}
\end{align}

\begin{align}
\label{eq:DWavePhi2CBar}
\nonumber \left(\bar{\phi}_{2j},\mathcal{L} \bar{C}_\ell\right) =& \sqrt{2} \cdot 2\pi \bigintsss \phi_{2j} \left[ \left( \frac{3(r_1 \cos\theta_{12} + r_2)^2}{8 \rho^2} - \frac{1}{2} \right) \mathscr{L}C_\ell \right.\\
& \left. \pm \left( \frac{3(r_1 \cos\theta_{12} + r_3 \cos\theta_{23})^2}{8 {\rho^\prime}^2} - \frac{1}{2} \right) \mathscr{L}C_\ell^\prime \right] d\tau_{int}
\end{align}
...
\left(\bar{S}_\ell,\mathcal{L}\bar{S}_\ell\right) = \pm 2\pi \bigintsss \left\{ S_{22} S_{23} \left(\frac{2}{r_1} - \frac{2}{r_2} - \frac{2}{r_{13}} + \frac{2}{r_{23}} \right) \left[ \frac{3}{8} \frac{(4\rho^2 + 4 {\rho^\prime}^2 - r_{23}^2)^2}{16 \rho^2 {\rho^\prime}^2} - \frac{1}{2} \right] \right\} d\tau_{int}
\end{align}
\begin{align}
\label{eq:DWaveCBarSBar}
\left(\bar{C}_\ell,\mathcal{L}\bar{S}_\ell\right) = \pm 2\pi \bigintsss \left\{ S_{22} C_{23} \left(\frac{2}{r_1} - \frac{2}{r_2} - \frac{2}{r_{13}} + \frac{2}{r_{23}} \right) \left[ \frac{3}{8} \frac{(4\rho^2 + 4 {\rho^\prime}^2 - r_{23}^2)^2}{16 \rho^2 {\rho^\prime}^2} - \frac{1}{2} \right] \right\} d\tau_{int}
\end{align}
\begin{align}
\label{eq:DWaveSBarCBar}
\nonumber \left(\bar{S}_\ell,\mathcal{L}\bar{C}_\ell\right) = 2\pi \bigintsss \Bigg\{ \pm & S_{23} C_{22} \left(\frac{2}{r_1} - \frac{2}{r_2} - \frac{2}{r_{13}} + \frac{2}{r_{23}} \right) \left[ \frac{3}{8} \frac{(4\rho^2 + 4 {\rho^\prime}^2 - r_{23}^2)^2}{16 \rho^2 {\rho^\prime}^2} - \frac{1}{2} \right] \\
...
\nonumber \left(\bar{C}_\ell,\mathcal{L}\bar{C}_\ell\right) = 2\pi \bigintsss \Bigg\{ \pm & C_{23} C_{22} \left(\frac{2}{r_1} - \frac{2}{r_2} - \frac{2}{r_{13}} + \frac{2}{r_{23}} \right) \left[ \frac{3}{8} \frac{(4\rho^2 + 4 {\rho^\prime}^2 - r_{23}^2)^2}{16 \rho^2 {\rho^\prime}^2} - \frac{1}{2} \right] \\
