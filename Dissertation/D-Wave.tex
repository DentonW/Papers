...
%&+ Y_{1,+1}(\theta_1,\varphi_1) Y_{1,-1}(\theta_2,\varphi_2)
   %\left< 1,+1,1,-1 | 2,0 \right>,
\psi(\ell_1,\ell_2,L,M) = \psi(1,1,2,0) = \sum_{m=-1}^{+1} Y_{1,m}(\theta_1,\varphi_1) Y_{1,m}(\theta_2,\varphi_2)
    \left< 1,m; 1,-m,0 | 2,0 \right>
\end{equation}
...
\bottomrule
\end{tabular}
\caption{$^{1,3}$D comparisons. Values in the header are $\kappa$ in au. Exponents denote powers of 10.}
