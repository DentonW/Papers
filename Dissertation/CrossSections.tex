...
\begin{figure}
	...
	\caption{$S$-matrix complex Kohn singlet elastic partial wave cross sections and the sum through $\ell = 5$. An interactive version of this
...
\begin{figure}
	...
	\caption{$S$-matrix complex Kohn triplet elastic partial wave cross sections and the sum through $\ell = 5$. An interactive version of this
figure is available online \cite{Plotly}.}
