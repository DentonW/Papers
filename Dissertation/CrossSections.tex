...
\begin{figure}
	...
	\caption[$S$-matrix complex Kohn singlet elastic partial wave cross sections and the sum]{$S$-matrix complex Kohn singlet elastic partial wave cross sections and the sum through $\ell = 5$. An interactive version of this
...
\begin{figure}
	...
	\caption[$S$-matrix complex Kohn triplet elastic partial wave cross sections and the sum]{$S$-matrix complex Kohn triplet elastic partial wave cross sections and the sum through $\ell = 5$. An interactive version of this
figure is available online \cite{Plotly}.}
...
\begin{figure}
	...
	\caption[Percent difference of differential cross sections at all angles]{Percent difference of $\frac{d\sigma_{el}}{d\Omega}$ for upper limit of summations in \cref{eq:DiffCross} as $\ell_{max} = 3$ versus $\ell_{max} = 4$ for all angles and energies}
...
\begin{figure}
	...
	\caption[Percent difference of differential cross sections at all angles]{Percent difference of $\frac{d\sigma_{el}}{d\Omega}$ for upper limit of summations in \cref{eq:DiffCross} as $\ell_{max} = 4$ versus $\ell_{max} = 5$ for all angles and energies}
...
\begin{figure}
	...
	\caption[Percent difference of differential cross sections at selected angles]{Percent difference of $\frac{d\sigma_{el}}{d\Omega}$ for upper limit of summations in \cref{eq:DiffCross} as $\ell_{max} = 3$ versus $\ell_{max} = 4$ for selected angles}
...
\begin{figure}
	...
	\caption[Percent difference of differential cross sections at selected angles]{Percent difference of $\frac{d\sigma_{el}}{d\Omega}$ for upper limit of summations in \cref{eq:DiffCross} as $\ell_{max} = 4$ versus $\ell_{max} = 5$ for selected angles}
