...
\begin{figure}[H]
	...
	\caption{General scattering diagram. Modified from \url{http://commons.wikimedia.org/wiki/File:ScatteringDiagram.svg}}
...
\todoi{Also mention \cite{Engbrecht2008} so that it's clear there is experimental interest.}
