...
\begin{figure}
	...
	\caption{$S$-matrix complex Kohn singlet cross sections for each partial wave and the sum through $\ell = 5$. An interactive version of this
...
\begin{figure}
	...
	\caption{$S$-matrix complex Kohn triplet cross sections for each partial wave and the sum through $\ell = 5$. An interactive version of this
figure is available online \cite{Plotly}.}
...
The momentum transfer cross section, $\sigma_m$, has been used in plasma applications
\cite{Wang2014, McEachran2014}. Measurements of the momentum transfer cross section
