...
We get the phase shifts directly from the Kohn-type variational methods, but a 
...
%
%\todoi{Ortho-para conversion ratio in \cite{Massey1954,Biswas1998,Raya,Rayb}. Data from \cite{Biswas1998} pulled form plot using WebPlotDigitizer \cite{WebPlotDigitizer}}
%
