...
\todoi{Not only the 1/r23 term - also can be 1/r12 and 1/r13}
...
\begin{figure}[H]
	...
	\caption{$^1$S resonance data showing raw data from complex Kohn and the corrected version. The solid gray line shows the polynomial background.}
