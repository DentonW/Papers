...
\noindent The $j_1(\kappa\rho)$ and $n_1(\kappa\rho)$ are the spherical Bessel and Neumann functions given by \cite[p. 729]{Weber}
\begin{subequations}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=7in]{OtherPWaveSingletResults}
	\caption{Comparison of P-Wave Singlet Results}
	\label{fig:OtherPWaveSingletResults}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=7in]{OtherPWaveTripletResults}
	\caption{Comparison of P-Wave Triplet Results}
	\label{fig:OtherPWaveTripletResults}
\end{figure}
