...
\beq
\SphericalHarmonicY{1}{0}{\theta_\rho}{\varphi_\rho} = \frac{1}{\sqrt{4\pi}}
\eeq
...
\beq
\frac{1}{2} \left(\Laplacian_\rho + \kappa^2\right) \SphericalHarmonicY{1}{0}{\theta_\rho}{\varphi_\rho} n_1(\kappa\rho) f_1(\rho) = -\frac{\rho  f^{\prime\prime}(\rho ) \left[\kappa  \rho  \sin (\kappa  \rho )+\cos (\kappa  \rho )\right]+2 f^\prime(\rho ) \left[\left(\kappa ^2 \rho ^2-1\right) \cos (\kappa  \rho )-\kappa  \rho  \sin (\kappa \rho )\right]}{2 \kappa ^2 \rho ^3}
\eeq
...
\begin{align}
\bar{S} &= \frac{Y_{10}(\theta_\rho,\varphi_\rho)S_{22} \pm Y_{10}(\theta_{\rho^\prime},\phi_{\rho^\prime})S_{23} }{\sqrt{2}} \label{eq:PWaveSBar} \\
\bar{C} &= \frac{Y_{10}(\theta_\rho,\varphi_\rho)C_{22} \pm Y_{10}(\theta_{\rho^\prime},\phi_{\rho^\prime})C_{23} }{\sqrt{2}} \label{eq:PWaveCBar} 
\end{align}
\end{subequations}
