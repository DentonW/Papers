...
Both of these equations are variations on Gaussian quadratures. The Chebyshev-Gauss quadrature is given by \cite{Abramowitz1965,MathworldChebyshevGauss}
...
Using the substitution $x = \cos \varphi$ and $dx = -\sin \varphi \:d\varphi$ changes the limits to $x_{min} \!\!=\! \cos 0 \! =\! 1$ and $x_{max} = \cos \pi = -1$. \Cref{eq:PVRAngNew2} becomes
...
procedure described here is the same as in Peter Van Reeth's thesis
\cite{VanReethThesis}.
