...
\todoi{Check that this isn't \citep[p. 620]{Bransden2003} instead}
...
\begin{figure}[H]
	...
	\caption{Percentage difference comparison between singlet and triplet higher partial waves}
	\label{fig:singlet-triplet-compare}
\end{figure}

\todoi{Maybe provide percent differences between the different cross sections as I did in my email to Dr. Quintanilla}
