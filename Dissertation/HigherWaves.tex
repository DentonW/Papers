...
\begin{figure}[H]
	\centering
	\includegraphics[width=6in]{fwave-phases}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=6in]{gwave-phases}
...
\begin{figure}[H]
	...
	\caption{Combined Singlet Cross Sections}
	\label{fig:singletcross}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=6in]{triplet-cross-sections}
	\caption{Combined Triplet Cross Sections}
	\label{fig:tripletcross}
\end{figure}
...
For the total cross section, including both the singlet and the triplet states, the singlet contributes $\frac{1}{4}$, and the triplet contributes $\frac{3}{4}$.

$\textbf{@TODO}$ Where did I find this information? Maybe look at notes from when Dr. Robicheaux met with us.


\section{Cross Section Comparisons}
