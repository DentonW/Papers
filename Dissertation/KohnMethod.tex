...
The $(\widetilde{S},\mathcal{L}\widetilde{S})$, $(\widetilde{C},\mathcal{L}\widetilde{S})$, and $(\bar{\phi}_1,\mathcal{L}\widetilde{S})$ matrix elements in \cref{eq:GeneralKohnMatrix} require us to first determine $\mathcal{L}\widetilde{S}$. We start with examining $\mathcal{L}S$ first.

\begin{align}
\label{eq:LS1}
\mathcal{L}S = &\left(-\frac{1}{2} \Laplacian_\rho - \Laplacian_{r_3} - 2 \Laplacian_{r_{12}} + \frac{2}{r_1} - \frac{2}{r_2} - \frac{2}{r_3} - \frac{2}{r_{12}} - \frac{2}{r_{13}} + \frac{2}{r_{23}} - 2 E_H - 2 E_{Ps} - \frac{1}{2} \kappa^2\right) \nonumber \\
