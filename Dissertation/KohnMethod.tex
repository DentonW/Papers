...
\todoi{Replace $\bar{\phi}_i$ with $\bar{\phi}_i$ for general!}
...
given in this table is substituted in \cref{eq:LC2} to find the full $\mathcal{L}C$.
...
\section{Matrix Element Symmetries}
