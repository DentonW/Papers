...
Positronium (Ps) is an exotic atom formed from the bound state of a positron %\todo{onium?} 
...
\begin{equation}
\mu_{\rm{H}} = \frac{m_{\rm{p}} m_{\rm{e}}}{m_{\rm{p}} + m_{\rm{e}}}.
\end{equation}
...
\lim_{m_{\rm{p}} \to \infty} \frac{m_{\rm{p}} m_{\rm{e}}}{m_{\rm{p}} + m_{\rm{e}}} = m_{\rm{e}} \approx \mu_{\rm{H}}.
\end{equation}
...
as $m_{{\rm{e}}^+} = m_{{\rm{e}}^-} = m_{\rm{e}}$.
\begin{equation}
\mu_{\rm{Ps}} = \frac{m_{\rm{e}}^2}{2 m_{\rm{e}}} = \frac{m_{\rm{e}}}{2}.
\end{equation}

To obtain the Ps wavefunction, we can start with the wavefunction for H and
replace $m_{\rm{e}} \rightarrow \frac{m_{\rm{e}}}{2}$. The ground state wavefunction for H is
\begin{equation}
\Phi_{100,\rm{H}} = \left(\frac{1}{\pi a_0^3}\right)^{\frac{1}{2}} \!\! \ee^{-\frac{r}{a_0}},
\text{where } a_0 = \frac{\hbar^2}{m_{\rm{e}} \,e^2} \;.
\end{equation}
...
we replace $m_{\rm{e}}$ by $m_{\rm{e}}/2$, the positronium ground state
wavefunction can be written easily as
\begin{equation}
\Phi_{100,\rm{Ps}} = \left(\frac{1}{\pi {a_\mu}^3}\right)^{\frac{1}{2}} \!\! \ee^{-\frac{r}{a_\mu}},
\text{where } a_\mu = \frac{2\hbar^2}{m_{\rm{e}} \,e^2} \;.
\end{equation}
Working in atomic units (see \cref{sec:Units}), $a_0 = 1$ (i.e. $\hbar = m_{\rm{e}} = e = 1$), giving
\begin{equation}
...
% http://journals.aps.org/copyrightFAQ.html#thesis
...
Physical Review A \cite{Woods2015}. Additional notes for derivations are
...
These notes and codes are also linked at \url{http://www.dentonwoods.com}.
