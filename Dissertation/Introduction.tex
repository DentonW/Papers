...
\begin{figure}[H]
	...
	\caption[Comparisons of e$^-$, e$^+$, and Ps scattering]{Comparisons of e$^-$, e$^+$, and Ps scattering from different atomic
and molecular targets from Ref.~\cite{Brawley2010a}. Reprinted with permission from AAAS.}
...
\todoi{Fabrikant and Gribakin paper compared e-, e+ and Ps \cite{Fabrikant2014}}
...
\todoi{Mention \cite{Kadyrov2015} and \cite{Kadyrov2015b} for antihydrogen production with excited Ps, and \cite{Kadyrov2013} and \cite{Elkilany2014} for ground state Ps}
\todoi{H-$\bar{\rm{H}}$ in \cite{Armour2002}}
