...
parameters found by the simplex method and  given in
...
The final ``optimal'' set of integration points is given in 
\cref{tab:OptimalEffectiveCoords}. This is the set used for all partial waves
through the H-wave.
...
this table is referred to as an ``effective coordinate''. \Cref{tab:EffectiveCoords}
describes what each of these refers to.
...
\bottomrule
\end{tabular}
\caption{Description of the values in \cref{tab:BaseEffectiveCoords,tab:OptimalEffectiveCoords}}
...
With the help of Bosca \cite{RyanBosca}, I wrote a MATLAB\textsuperscript{\textregistered}
...
any Kohn method. The mlabwrap package is difficult to install properly, 
