...
The scattering wave function 
 contains both the asymptotic form
and short-range correlation terms for small
interparticle distances.
The short-range correlation terms are Hylleraas-type
functions  which allow for all inter-particle correlations.
For the S-wave,  the short-range correlation  terms 
are of the form
...
e^{-2(\alpha r_1 + \beta r_2 + \gamma r_3)}\, .\eqno(2)
$$
