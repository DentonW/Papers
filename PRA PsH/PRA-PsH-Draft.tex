...
Born-Oppenheimer approximation (B1) to $\tan\delta_\ell$ of \cite{Bransden2003}
\begin{equation}
\label{eq:Born}
\tan\delta_\ell^{B1} = -(\bar{S}_\ell,\mathcal{L}\bar{S}_\ell)\,.
\end{equation}
We also consider a modified Born-Oppenheimer approximation to $\tan\delta_\ell$ that uses
...
compared to the Born-Oppenheimer approximations. As for the $^3D$, there is a sign change 
...
The modified Born-Oppenheimer approximation phase shifts are nearly equivalent to
the Born-Oppenheimer approximation 
phase shifts, so we show only the Born-Oppenheimer results in this figure.
The Born-Oppenheimer approximation phase shifts do
not agree well with the complex Kohn phase shifts, being much lower. We 
also find little agreement between the Born-Oppenheimer approximation and the complex 
...
matching on to the Born-Oppenheimer approximation results for $\ell \geq 5$.
