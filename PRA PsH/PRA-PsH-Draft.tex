...
\begin{table}[H]
  \centering
	...
	$N^\prime(\omega)$ & 1505  & 1633  & 1000  & 1000  & 916 $(\kappa < 0.3)$   & 919 $(\kappa < 0.3)$   & 462  & 462 & 462 \\
	$N^\prime(\omega)$ &   &   &   &   & 913 $(\kappa \geq 0.3)$   & 913 $(\kappa \geq 0.3)$   &   &  &  \\
	$\alpha$           & 0.586 & 0.323 & 0.397 & 0.310 & 0.359 $(\kappa < 0.3)$ & 0.356 $(\kappa < 0.3)$ & 0.5  & 0.5 & 0.5 \\
...
\colrule
$0.1$ & $1.36^{-4}$ & $1.46^{-4}$ & $5.81^{-5}$ & $8.48^{-5}$ \\
$0.2$ & $2.99^{-3}$ & $3.15^{-3}$ & $7.12^{-4}$ & $1.15^{-3}$ \\
$0.3$ & $1.60^{-2}$ & $1.65^{-2}$ & $1.10^{-3}$ & $2.84^{-3}$ \\
$0.4$ & $4.98^{-2}$ & $4.95^{-2}$ & $-1.80^{-3}$ & $2.37^{-3}$ \\
$0.5$ & $1.13^{-1}$ & $1.08^{-1}$ & $-1.07^{-2}$ & $-4.66^{-3}$ \\
$0.6$ & $2.06^{-1}$ & $1.94^{-1}$ & $-2.54^{-2}$ & $-1.85^{-2}$ \\
$0.7$ & $3.28^{-1}$ & $3.02^{-1}$ & $-4.28^{-2}$ & $-3.27^{-2}$ \\
\end{tabular}
\end{ruledtabular}
