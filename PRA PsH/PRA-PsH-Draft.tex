...
\begin{table}[H]
  \centering
	\begin{ruledtabular}
    \begin{tabular}{ccccc}
    Param. & $^1$F & $^3$F & $^1$G,$^1$H & $^3$G,$^3$H \\
    \colrule
	$\omega$           & 5 & 5 & 5 & 5  \\
	$N^\prime(\omega)$ & $385^\star$ $(\kappa < 0.4)$ & $385^\star$ $(\kappa < 0.4)$  & $385^\star$ $(\kappa < 0.45)$ & $385^\star$ $(\kappa < 0.45)$ \\
	$N^\prime(\omega)$ & 462 $(\kappa \geq 0.4)$ &  462 $(\kappa \geq 0.4)$  & 462 $(\kappa \geq 0.45)$ &  462 $(\kappa \geq 0.45)$\\
	$\alpha$           & 0.359 $(\kappa < 0.4)$ & 0.356 $(\kappa < 0.4)$ & 0.359 $(\kappa < 0.45)$ & 0.356 $(\kappa < 0.45)$  \\
	$\alpha$           & 0.6 $(\kappa \geq 0.4)$ & 0.6 $(\kappa \geq 0.4)$ & 0.6 $(\kappa \geq 0.45)$ & 0.6 $(\kappa \geq 0.45)$  \\
	$\beta$            & 0.368 & 0.365  & 0.368 & 0.365  \\
	$\gamma$           & 0.976 & 0.976 & 0.976 & 0.976  \\
	$\mu$              & 0.7  & 0.7 & 0.7  & 0.7 \\
	$m_\ell$           & 7    & 7   & $2\ell+1$    & $2\ell+1$  \\
    \end{tabular}
  \end{ruledtabular}
...
\todoi{Should we add the $\omega = 4$ to $5$ F-wave percent difference to the text? They are huge for the triplet and decent for the singlet. Refer to the spreadsheet.}
...
evident in Fig. \ref{fig:fwave-phases}. The modified Born is approximately 
...
by the short-range terms used} in Sec. \ref{sec:Parameters}. For the
...
%\todoi{Be clear on this. We get the same as others at higher kappa values}
