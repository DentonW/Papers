...
We \hl{investigate} low-energy elastic scattering of ground-state Ps
with ground-state H, Ps(1s)+H(1s), for incident energies up to the \hl{excitation
threshold of Ps(n=2).}
...
here we present in
this section a general wavefunction that can be used in the \hl{Kohn
variational method and any of its variants,}
as we describe in Sec.~\ref{sec:Kohn}.
\sout{We use the variants of the Kohn variational method to obtain estimates
