...
and is of interest in the study of solar processes \cite{Crannell1976}.
...
the Stochastic Variational Method (SVM) \cite{Ivanov2001,Ivanov2002}, and Close Coupling (CC) \cite{Blackwood2002,Blackwood2002b,Walters2004} methods have been applied.
...
The most recent calculation of Ps-H scattering uses the confined variational method (CVM) \cite{Zhang2012}. This provides very accurate results but has the drawback of being very computationally expensive. In ref. \cite{Zhang2012}, they calculate phase shifts for 2 momenta for both $^1S$ and $^3S$.
...
\end{equation}
The effective range is a measure of the interaction region of the scattering problem. This is the standard fitting used throughout the literature \cite{Blackwood2002,Walters2004,VanReeth2003}. As pointed out in Ref. \cite{Fabrikant2014}, the van der Waals interaction should be taken into account for low-energy Ps-atom scattering. If this van der Waals potential is taken into account, the effective range equation is \cite[p. 668]{Drake2006}
\begin{equation}
...
Figure \ref{fig:spd-wave-phases}(a) shows the two $^1S$ Rydberg resonances below the
