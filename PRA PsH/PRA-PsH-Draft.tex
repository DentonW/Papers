...
of the incoming Ps(1s). The number of sets of short-range terms with different
symmetry with parity $\ell$ are $\ell + 1$
\cite{Schwartz1961a,Brown1985a,BrownThesis,WattsThesis,Humberston1997,VanReeth1997,Armour1991}.
For partial waves $\ell > 0$, we consider a trial
...
\end{equation}
where we neglect mixed symmetry terms for $\ell \ge 2$.
...
wavefunction where the angular momentum was placed on the Ps
