...
energy. The total energy and binding energy
...
\end{tabular}
\end{ruledtabular}
\caption{Positronium hydride energy comparisons - Starred values are the reported values. Unstarred values are obtained by using the conversion factor given in \cite{NISTConversions}. \emph{Do we need to include terms?}}
...
$\kappa$ (au) & $\delta_0^+ (\omega = 7)$ & $\delta_0^+ (\omega =\infty)$ & \% Diff$^+$ & $\delta_0^+$ (VH) & $\delta_0^+$ (WYSG) & $\delta_0^- (\omega = 7)$ & $\delta_0^- (\omega = \infty)$ & \% Diff$^-$ & $\delta_0^-$ (VH) & $\delta_0^-$ (BMW) \\
\colrule
0.1 & -0.427 & -0.426 & 0.223\% & -0.427 & -0.432 & -0.215 & -0.214 & 0.120\% & -0.214 & -0.206 \\
0.2 & -0.820 & -0.819 & 0.010\% & -0.820 & -0.833 & -0.431 & -0.431 & 0.063\% & -0.432 & -0.414 \\
0.3 & -1.161 & -1.161 & 0.040\% & -1.161 & -1.179 & -0.645 & -0.645 & 0.094\% & -0.645 & -0.624 \\
0.4 & -1.446 & -1.446 & 0.022\% & -1.446 & -1.466 & -0.850 & -0.849 & 0.130\% & -0.850 & -0.838 \\
0.5 & -1.678 & -1.677 & 0.031\% & -1.677 & -1.699 & -1.041 & -1.040 & 0.166\% & -1.040 & -1.037 \\
0.6 & -1.858 & -1.857 & 0.040\% & -1.857 & -1.884 & -1.217 & -1.214 & 0.273\% & -1.215 & -1.213 \\
0.7 & -1.964 & -1.963 & 0.045\% & -1.964 & -2.012 & -1.375 & -1.372 & 0.250\% & -1.373 & -1.367 \\
\end{tabular}
\end{ruledtabular}
...
$\kappa$ (au) & $\delta^+ (\omega = 7)$ & $\delta^+ (\omega = \infty)$ & \% Diff$^+$ & $\delta^+$ \cite{VanReethPrivate} & $\delta^+$ (WYSG) & $\delta^- (\omega = 7)$ & $\delta^- (\omega = \infty)$ & \% Diff$^-$ & $\delta^-$ (BMW) \\
\colrule
0.1 & $0.226^{-1}$ & $0.227^{-1}$ &  & $0.226^{-1}$ & $0.221^{-1}$ & $-0.178^{-2}$ & $-0.172^{-2}$ &  & $-0.953^{-3}$ \\
0.2 & $0.191$      & $0.192$     &  & $0.192$     & $0.183$     & $-0.167^{-1}$    & $-0.165^{-1}$ &  & $-0.122^{-1}$ \\
0.3 & $0.609$      & $0.611$     &  & $0.612$     & $0.580$     & $-0.552^{-1}$    & $-0.540^{-1}$ &  & $-0.456^{-1}$ \\
0.4 & $0.994$      & $0.996$     &  & $0.997$     & $0.956$     & $-0.115$         & $-0.114$      &  & $-0.104$ \\
0.5 & $1.140$      & $1.142$     &  & $1.143$     & $1.106$     & $-0.183$         & $-0.182$      &  & $-0.178$ \\
0.6 & $1.162$      & $1.163$     &  & $1.165$     & $1.134$     & $-0.248$         & $-0.246$      &  & $-0.247$ \\
0.7 & $1.152$      & $1.154$     &  & $1.155$     & $1.133$     & $-0.292$         & $-0.281$      &  & $-0.295$ \\
\end{tabular}
\end{ruledtabular}
...
$\kappa$ & $\delta^+ (\omega = 6)$ & $\delta^+$ (WYSG) & $\delta^- (\omega = 6)$ & $\delta^-$ (BMW) \\
\colrule
...
\begin{figure}[ht]
	...
	\caption{Differential cross sections for selected angles}
...
\begin{figure}[ht]
	...
	\caption{Differential cross sections for selected incident Ps momenta}
...
We observed no resonances in the triplet, which
