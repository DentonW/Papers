...
that these mixed terms contribute can be important for that 
system. At very low energies, the mixed terms are negligible, and near
the Ps formation threshold, the mixed terms contribute about 15\%.
...
\end{tabular}
\end{ruledtabular}
\caption{$^1S$ resonance parameters} % title of Table
...
\end{tabular}
\end{ruledtabular}
\caption{$^1P$ resonance parameters} % title of Table
...
\end{tabular}
\end{ruledtabular}
\caption{$^1D$ resonance parameters} % title of Table
...
\end{tabular}
\end{ruledtabular}
\caption{$^1F$ resonance parameters} % title of Table
