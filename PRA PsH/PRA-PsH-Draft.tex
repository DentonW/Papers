...
As pointed out in Ref. \cite{Buckman1989}, $\sigma_m = \sigma_{el}$ for zero energy. From Fig. \ref{fig:cross-section-comparisons}, we can see that this is the case. For very low energies ($E < 10^{-6}$ eV), $\sigma_m = \sigma_{el} = 32.45$. The ortho-para cross section, $\sigma_C$, is much lower than the elastic and momentum transfer cross sections.
