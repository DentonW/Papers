...
\subsection{Nonlinear Parameters and Terms in Scattering Wavefunction}
...
compares our $^1$S PsH bound state energies with that obtained by
other groups.
...
using BO phase shifts for $\ell > 5$.
