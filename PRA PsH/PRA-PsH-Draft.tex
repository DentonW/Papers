...
\begin{itemize}
  \item Kohn variational method
  \item phase shifts for the first six partial waves
  \item benchmark results for the S-wave and P-wave
  \item elastic differential, elastic total, momentum transfer, and ortho-para conversion cross sections
  \item effective range, scattering length
\end{itemize}
